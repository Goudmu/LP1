...
export const SlideshowProduct = () => {
  ...
  if (contents.length != 0) {
    return (
      <div className=" h-[85vh] relative flex m-auto box-border">
        <div className=" relative flex-1 h-full w-full flex items-center justify-center ml-20">
          <motion.img
            key={imageIndex}
            ...
            className=" rounded-full aspect-video absolute w-96 h-96 object-cover object-center"
            drag="x"
        ...
        <div className=" flex-1 w-full h-full relative mr-20">
          <motion.h1
            key={imageIndex}
            custom={direction}
            variants={variantsH1}
            ...
            className="absolute top-[calc(10%)] left-20 text-[#FB8B24] font-extrabold text-4xl px-3 py-2 rounded-md underline"
          >
          ...
          <motion.div
            ...
            className="absolute top-[calc(15%)] left-20 text-white font-bold text-xl py-[1px] rounded-md"
          >
            <h2 className="text-[#FB8B24] w-fit font-bold text-xl  px-1 py-[1px] rounded-md my-5">
          ...
          <motion.h1
            ...
            className="absolute top-2/4 left-20 text-[#FB8B24] font-extrabold text-4xl px-3 py-2 rounded-md underline"
          >
            Compotition
          </motion.h1>
          <motion.div
            ...
            className="absolute top-[calc(55%)] left-20 text-white font-bold text-xl py-[1px] rounded-md"
          >
            <h2 className="text-[#FB8B24] w-fit font-bold text-xl  px-1 py-[1px] rounded-md my-5">
